    ...
    <div className="w-full flex justify-center items-center min-h-screen grainy">
      <div className="w-full flex justify-around items-center px-10">
        <div className="flex-col items-start h-full">
          ...
          <Typography variant="h6" className="mt-4">A place where you can learn and grow</Typography>
          <Typography variant="h6">Be <span className="font-bold">Better</span> than Yesterday</Typography>
          <Button variant="contained" size="large" className="bg-blue-500 mt-5">Get started</Button>
          <Button variant="contained" size="large" className="bg-blue-500 mt-5 mx-6">Explore courses</Button>
        </div>
        <div className="">
          <Image src="/board.jpg"
            width={700}
